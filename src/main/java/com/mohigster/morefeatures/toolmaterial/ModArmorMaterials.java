...
public interface ModArmorMaterials {
    ...
    ArmorMaterial CARBON = new ArmorMaterial(36, makeDefense(3, 6, 8, 3, 19), 15, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, 0.10F, ModItemTags.REPAIRS_CARBON_ARMOR, ModEquipmentAssets.CARBON);
