...
public record MultiBaseSpeleothemClusterConfiguration(
        List<BlockState> baseBlocks,
    ...
    public static final MapCodec<MultiBaseSpeleothemClusterConfiguration> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            BlockState.CODEC.listOf(1, 64).fieldOf("base_blocks")
            ...
            IntProviders.codec(1, 128).fieldOf("height")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::height),
            IntProviders.codec(1, 128).fieldOf("radius")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::radius),
            Codec.intRange(0, 64).fieldOf("max_stalagmite_stalactite_height_diff")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::maxStalagmiteStalactiteHeightDiff),
            Codec.intRange(1, 64).fieldOf("height_deviation")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::heightDeviation),
            IntProviders.codec(0, 128).fieldOf("speleothem_block_layer_thickness")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::speleothemBlockLayerThickness),
            FloatProviders.codec(0.0F, 2.0F).fieldOf("density")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::density),
            FloatProviders.codec(0.0F, 2.0F).fieldOf("wetness")
                    .forGetter(MultiBaseSpeleothemClusterConfiguration::wetness),
            ...
            Codec.intRange(1, 64)
                    ...
                    i,
                    MultiBaseSpeleothemClusterConfiguration::new
            )
    );
