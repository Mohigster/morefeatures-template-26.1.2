...
public class MFNetherBiomes {
    public static Biome charredForest(HolderGetter<PlacedFeature> featureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter){
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, MFPlacedFeatures.CHARRED_PLACED_KEY);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, MFPlacedFeatures.CHARRED_FOREST_VEGETATION_PLACED_KEY);
