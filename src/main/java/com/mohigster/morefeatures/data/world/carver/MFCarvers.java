package com.mohigster.morefeatures.data.world.carver;
...
public class MFCarvers {
    ...
    private static ResourceKey<ConfiguredWorldCarver<?>> createKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_CARVER, MFIdentifier.withMfNamespace(name));
    }

    public static void bootstrap(BootstrapContext<ConfiguredWorldCarver<?>> context) {
        HolderGetter<Block> blocks = context.lookup(Registries.BLOCK);
        context.register(ICE_CAVE, WorldCarver.CAVE.configured(
                new CaveCarverConfiguration(
                        ...
                        CarverDebugSettings.of(false, Blocks.CAVE_AIR.defaultBlockState()),
        ...
        context.register(ICE_CAVE_EXTRA_UNDERGROUND, WorldCarver.CAVE.configured(
                new CaveCarverConfiguration(
                        0.07F,
                        UniformHeight.of(
                                VerticalAnchor.aboveBottom(0),
        ...
        context.register(ICE_CANYON, WorldCarver.CANYON.configured(
