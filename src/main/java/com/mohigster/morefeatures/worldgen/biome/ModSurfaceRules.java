...
public class ModSurfaceRules {
    ...
    private static final RuleSource PALLID_NULLIUM = makeStateRule(ModBlocks.PALLID_NULLIUM.get());
    private static final RuleSource DECREPIT_NULLIUM = makeStateRule(ModBlocks.DECREPIT_NULLIUM.get());
