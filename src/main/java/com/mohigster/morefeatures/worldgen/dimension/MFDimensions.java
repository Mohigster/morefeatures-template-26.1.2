...
import com.mohigster.morefeatures.worldgen.noise.MFNoiseGeneratorSettings;
...
public class MFDimensions {
    ...
    public static final ResourceKey<DimensionType> EVIL_DIM_TYPE_KEY = ResourceKey.create(Registries.DIMENSION_TYPE,
            MFIdentifier.withMfNamespace("evildim_type"));
    ...
    public static void bootstrapStem(BootstrapContext<LevelStem> context) {
        ...
        context.register(EVILDIM_KEY, new LevelStem(dimensionTypes.getOrThrow(MFDimensions.EVIL_DIM_TYPE_KEY), multiBiomeGenerator));
    }
}
