...
public class ModEnchantments {
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, THUNDERBOLT, Enchantment.enchantment(Enchantment.definition(items.getOrThrow(ModItemTags.BOW_UPGRADE_ENCHANTABLE),
                        items.getOrThrow(ModItemTags.BOW_UPGRADE_ENCHANTABLE), 5, 2,
        ...
        register(context, THUNDERING, Enchantment.enchantment(Enchantment.definition(items.getOrThrow(ModItemTags.MELEE_WEAPON_UPGRADE_ENCHANTABLE),
                        items.getOrThrow(ModItemTags.MELEE_WEAPON_UPGRADE_ENCHANTABLE), 5, 2,
                        Enchantment.dynamicCost(5, 8), Enchantment.dynamicCost(25, 8), 3, EquipmentSlotGroup.MAINHAND))
                .withEffect(
                        EnchantmentEffectComponents.POST_ATTACK,
                        EnchantmentTarget.ATTACKER,
    ...
    private static ResourceKey<Enchantment> registerKey(String id) {
        return ResourceKey.create(Registries.ENCHANTMENT, Identifier.fromNamespaceAndPath(MoreFeatures.MODID, id));
    }
