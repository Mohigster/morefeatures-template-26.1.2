...
public class FireWandItem extends AimableWandItem {
    private static final double SPREAD_RADIUS = 0.1F;
    private static final boolean VARIABLE_SPREAD = false; // Determines if the amount of spread varies between zero and SPREAD_RADIUS, instead of being directly set to SPREAD_RADIUS
    ...
    private static final int BONUS_PROJECTILES = 2;

    private static final float VOLUME = 1.0F;
    private static final float PITCH = 0.5F;

    public FireWandItem(Properties properties) {
        super(properties, SPREAD_RADIUS, VARIABLE_SPREAD, PROJECTILE_COUNT, BONUS_PROJECTILES, COOLDOWN, DURABILITY_COST, SoundEvents.FIRECHARGE_USE, VOLUME, PITCH);
    }
